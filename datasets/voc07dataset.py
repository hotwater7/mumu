...
class Voc07Dataset(data.Dataset):
    def __init__(self, img_dir='../data/VOCdevkit/VOC2007/JPEGImages',
                 anno_path='../data/VOCdevkit/VOC2007/Main/trainval.txt',
        ...
        for name in self.img_names:
            ...
            # Introduce random errors in labels
            for i in range(len(label_vector)):
                if random.random() < error_rate:
                    label_vector[i] = 1 - label_vector[i]
